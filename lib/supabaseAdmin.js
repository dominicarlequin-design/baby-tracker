...
// browser. Used by API routes / the cron job for the operations RLS doesn't
// grant to the public anon role: updating baby_events.event_time (Feature 1)
// and reading/writing alert de-dup state (Feature 2).
